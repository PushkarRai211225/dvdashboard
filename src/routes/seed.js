...
// Seed endpoint - Protected with secret key
router.post('/seed', async (req, res) => {
  try {
    ...
    if (providedSecret !== seedSecret) {
      return res.status(403).json({ message: 'Unauthorized: Invalid seed secret' });
    }
    ...
    res.json({
      ...
      credentials: {
        'Super Admin Phone': '9876543210',
        'Admin Phone': '9876543211',
        'Employees': [
          'John Smith: 9876543212',
          'Jane Doe: 9876543213',
          'Mike Johnson: 9876543214',
          'Sarah Williams: 9876543215',
          'David Brown: 9876543216',
        ],
